...
function generate(path, fileName, options) {
    return __awaiter(this, void 0, void 0, function () {
        var ext, _filename, name, Name, pathname, filename, componentCode;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    Name = utils_1.toUpperCase(name);
                    pathname = path;
                    filename = !!ext ? utils_1.toUpperCase(fileName) : Name + ".tsx";
                    componentCode = outComponentFuncCode(Name, options["server"]);
...
function outComponentFuncCode(name, server) {
