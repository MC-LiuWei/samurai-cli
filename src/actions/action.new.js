...
var applications_1 = require("../examples/applications");
var NewAction = /** @class */ (function (_super) {
    __extends(NewAction, _super);
    function NewAction() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    NewAction.prototype.handle = function (app, options) {
        return __awaiter(this, void 0, void 0, function () {
            var name, path;
            return __generator(this, function (_a) {
                name = app.name;
                path = options.find(function (item) { return item.name === 'path'; });
                if (!path)
                    process.exit(1);
                applications_1.generate(name, path.name);
                return [2 /*return*/];
            });
        });
    };
